...
- [x] **T102** Establish the small Material Symbols icon set and localized accessibility descriptions without adding a mega icon dependency.
- [x] **T103** Add only justified reusable application-specific UI components needed by multiple approved screens.
- [x] **T104** Verify the foundation on emulator and Samsung Galaxy A11 before broad rollout.
...
- [x] **T111** Refine Vault/Dashboard, including top-app-bar lock, search/sort, list rows, empty state, Extended FAB, and 3-item bottom navigation.
...
- [x] **T116** Ensure global Back/lock/navigation state follows `docs/UX_UI_BASELINE.md`.
...
- [x] **T121** Add static credential placeholders only where device testing shows perceptible content loading; do not add shimmer.
